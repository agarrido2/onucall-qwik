...
* **Regla 1.1 (Estructura de Página)**:
...
* **Regla 1.2 (Jerarquía de Contenido)**:
...
Una pobre accesibilidad es penalizada por los motores de búsqueda. El código debe ser accesible por defecto.
...
El rendimiento de carga es un factor de ranking crítico. Qwik está diseñado para esto, pero la implementación debe seguir las reglas.
...
- **[CAPITULO-17.md](./CAPITULO-17.md)** - SEO Y WEB VITALS  
  Documentación profunda de Qwik sobre optimización SEO automática, Core Web Vitals, sitemap y robots.txt. **Consulta este capítulo para entender los fundamentos técnicos de Qwik aplicados al SEO.**

- **[CAPITULO-13.md](./CAPITULO-13.md)** - SSR Y PERFORMANCE  
  Estrategias de renderizado (SSR, SSG, ISR), bundles y automatización de Core Web Vitals en Qwik.
