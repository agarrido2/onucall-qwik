...
export const Icon = component$<IconProps>(({ name, size, color, class: className, ...props }) => {
  ...
  return (
    <div
      class={[iconVariants({ size, color }), className]}
      {...props}
    >
      {iconElement}
    </div>
