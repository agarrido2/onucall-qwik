...
export const Footer = component$(() => {
  ...
  return (
    <footer class="bg-gray-950 px-4 py-16 text-gray-400 sm:px-6 lg:px-8">
      <div class="mx-auto max-w-screen-xl">
        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          {/* Columna 2 - Producto */}
          <div>
            <h3 class="mb-4 text-lg font-semibold text-white">Producto</h3>
            <ul class="space-y-3">
              <li>
          ...
          {/* Columna 3 - Empresa */}
          <div>
            <h3 class="mb-4 text-lg font-semibold text-white">Empresa</h3>
            <ul class="space-y-3">
              <li>
